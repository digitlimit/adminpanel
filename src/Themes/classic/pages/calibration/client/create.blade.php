...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form role="form" action="{{route('adminpanel.calibration.client.postStore')}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="name" name="name" value="{{old('name')}}" placeholder="Enter client name">
                                    </div>
                                    <div class="form-group">
                                        <label for="detail">Client Information (Optional)</label>
