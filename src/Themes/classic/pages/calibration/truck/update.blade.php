    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                <form role="form" action="{{route('adminpanel.page.postUpdate', ['id'=>$page->id])}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="title" name="title" value="{{old('title') ? old('title') : $page->title}}" placeholder="Enter page title">
                                    </div>
                                    <div class="form-group">
                                        <label for="summary">Summary (Optional)</label>
                                        <input type="text" class="form-control input-lg" id="summary" name="summary" value="{{old('summary') ? old('summary') : $page->summary}}" placeholder="Page Summary">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg date no-radius">
                                            ...
                                            <input type="text" placeholder="Published date" class="datepicker form-control pull-right" id="published_date" name="published_date" value="{{old('published_date') ? old('published_date') : $page->published_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="meta_keywords" name="meta_keywords" value="{{old('meta_keywords') ? old('meta_keywords') : $page->meta_keywords}}" placeholder="Page keywords separate with comma e.g. first aid, skills">
                                    </div>

                                    <div class="form-group">
                                        <label for="icon">Icon Class (Optional)</label>
                                        <input type="text" class="form-control input-lg" id="icon" name="icon" value="{{old('icon') ? old('icon') : $page->icon}}" placeholder="e.g. fa fa-home">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-lg" id="template" name="template">
                                            ...
                                            <?php if(!$template = old('template')) $template = $options['selected']['template']; ?>
                                            @if(is_array($options['template']))
                                                @foreach($options['template'] as $value=>$label)
                                                    <option value="{{$value}}" {{$value == $template ? 'selected' : ''}}>{{$label}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content" id="content" class="form-control summernote">{{old('content') ? old('content') : $page->content }}</textarea>
                                </div>
