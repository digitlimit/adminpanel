<?php namespace Digitlimit\Adminpanel\Plugins\Video\Http\Controllers;

use Illuminate\Contracts\Auth\Guard as Auth;
use Digitlimit\Adminpanel\Http\Services\VideoService;

use Digitlimit\Adminpanel\Plugins\Video\Http\Requests\Video\StoreRequest;
use Digitlimit\Adminpanel\Plugins\Video\Http\Requests\Video\UpdateRequest;
...
class VideoController extends Controller
{
	...
	{
		$video = $request->only(['title', 'detail', 'youtube', 'video', 'privacy']);
	...
	public function postUpdate(UpdateRequest $request, $id)
	{
		...
		$fields = $request->only(['title', 'detail', 'youtube', 'video', 'privacy']);
