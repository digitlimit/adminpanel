...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form role="form" action="{{route('adminpanel.video.postStore')}}" method="post">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="title" name="title" value="{{old('title')}}" placeholder="Enter video title">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="video" name="video" value="{{old('video')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="youtube" name="youtube" value="{{old('youtube')}}" placeholder="Enter video youtube">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-lg" id="privacy" name="privacy" value="{{old('privacy')}}">
