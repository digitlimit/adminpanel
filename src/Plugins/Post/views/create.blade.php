...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form role="form" action="{{route('adminpanel.post.postStore')}}" method="post">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="title" name="title" value="{{old('title')}}" placeholder="Enter post title">
                                    </div>
                                    <div class="form-group">
                                        <label for="summary">Summary (Optional)</label>
                                        <input type="text" class="form-control input-lg" id="summary" name="summary" value="{{old('summary')}}" placeholder="Post Summary">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="tags" name="tags" value="{{old('tags')}}" placeholder="Post tags e.g. skills, forex">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-lg" id="category" name="category">
                                            ...
                                            <?php if(!$category = old('category')) $category = $options['selected']['category']; ?>

                                            @foreach($options['category'] as $value=>$label)
