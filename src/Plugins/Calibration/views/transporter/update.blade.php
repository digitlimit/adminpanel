    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                <form role="form" action="{{route('adminpanel.calibration.transporter.postUpdate', ['id'=>$transporter->id])}}" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg" id="name" name="name" value="{{old('name') ? old('name') : $transporter->name}}" placeholder="Enter transporter">
                                    </div>
                                    <div class="form-group">
                                        <label for="detail">Transporter Information (Optional)</label>
                                        <textarea name="detail" id="detail" class="form-control summernote">{{old('detail') ? old('detail') : $transporter->detail}}</textarea>
                                    </div>
                                </div>
